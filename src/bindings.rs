...
pub type std___uset_hashtable = std__Hashtable___hashtable_base;
#[repr(C)]
#[derive(Debug)]
...
pub type const_pointer_2 = *const f64;
#[test]
fn __bindgen_test_layout___gnu_cxx___normal_iterator_open0_const_pointer_std_vector_open1_unsigned_long_std_allocator_open2_unsigned_long_close2_close1_close0_instantiation_1(
) {
    assert_eq!(
        ::std::mem::size_of::<__gnu_cxx___normal_iterator<const_pointer_2>>(),
        8usize,
        concat!(
            "Size of template specialization: ",
            stringify!(__gnu_cxx___normal_iterator<const_pointer_2>)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<__gnu_cxx___normal_iterator<const_pointer_2>>(),
        8usize,
        concat!(
            "Alignment of template specialization: ",
            stringify!(__gnu_cxx___normal_iterator<const_pointer_2>)
...
#[test]
fn __bindgen_test_layout_std_vector_open0_unsigned_long_std_allocator_open1_unsigned_long_close1_close0_instantiation_5(
) {
    assert_eq!(
        ::std::mem::size_of::<std_vector>(),
        24usize,
...
#[test]
fn __bindgen_test_layout_std_allocator_open0_unsigned_long_close0_instantiation_9() {
    assert_eq!(
        ::std::mem::size_of::<std_allocator>(),
        1usize,
        concat!(
...
#[test]
fn __bindgen_test_layout___gnu_cxx___normal_iterator_open0_const_pointer_std_vector_open1_double_std_allocator_open2_double_close2_close1_close0_instantiation(
) {
    assert_eq!(
        ::std::mem::size_of::<__gnu_cxx___normal_iterator<const_pointer_2>>(),
        8usize,
...
#[test]
fn __bindgen_test_layout_std_allocator_open0_unsigned_long_close0_instantiation_10() {
    assert_eq!(
        ::std::mem::size_of::<std_allocator>(),
        1usize,
        concat!(
...
#[test]
fn __bindgen_test_layout_std_vector_open0_NetworKit_node_std_allocator_open1_unsigned_long_close1_close0_instantiation_2(
) {
    assert_eq!(
        ::std::mem::size_of::<std_vector>(),
        24usize,
...
#[test]
fn __bindgen_test_layout_std_allocator_open0_unsigned_long_close0_instantiation_11() {
    assert_eq!(
        ::std::mem::size_of::<std_allocator>(),
        1usize,
        concat!(
...
#[test]
fn __bindgen_test_layout_std_pair_open0_NetworKit_node_NetworKit_node_close0_instantiation() {
    assert_eq!(
        ::std::mem::size_of::<std_pair<NetworKit_node, NetworKit_node>>(),
        16usize,
        concat!(
            "Size of template specialization: ",
            stringify ! ( std_pair < NetworKit_node , NetworKit_node > )
        )
    );
    assert_eq!(
        ::std::mem::align_of::<std_pair<NetworKit_node, NetworKit_node>>(),
        8usize,
        concat!(
            "Alignment of template specialization: ",
            stringify ! ( std_pair < NetworKit_node , NetworKit_node > )
...
#[test]
fn __bindgen_test_layout_std_pair_open0_NetworKit_node_NetworKit_node_close0_instantiation_1() {
    assert_eq!(
        ::std::mem::size_of::<std_pair<NetworKit_node, NetworKit_node>>(),
        16usize,
        concat!(
...
#[test]
fn __bindgen_test_layout_std_pair_open0_unsigned_long_unsigned_long_close0_instantiation() {
    assert_eq!(
        ::std::mem::size_of::<std_pair<::std::os::raw::c_ulong, ::std::os::raw::c_ulong>>(),
        16usize,
        concat!(
            "Size of template specialization: ",
            stringify ! ( std_pair < :: std :: os :: raw :: c_ulong , :: std :: os :: raw :: c_ulong > )
        )
    );
    assert_eq!(
        ::std::mem::align_of::<std_pair<::std::os::raw::c_ulong, ::std::os::raw::c_ulong>>(),
        8usize,
        concat!(
            "Alignment of template specialization: ",
            stringify ! ( std_pair < :: std :: os :: raw :: c_ulong , :: std :: os :: raw :: c_ulong > )
...
#[test]
fn __bindgen_test_layout_std_pair_open0_NetworKit_count_NetworKit_count_close0_instantiation() {
    assert_eq!(
        ::std::mem::size_of::<std_pair<NetworKit_count, NetworKit_count>>(),
        16usize,
        concat!(
            "Size of template specialization: ",
            stringify ! ( std_pair < NetworKit_count , NetworKit_count > )
        )
    );
    assert_eq!(
        ::std::mem::align_of::<std_pair<NetworKit_count, NetworKit_count>>(),
        8usize,
        concat!(
            "Alignment of template specialization: ",
            stringify ! ( std_pair < NetworKit_count , NetworKit_count > )
...
#[test]
fn __bindgen_test_layout_std_vector_open0_NetworKit_node_std_allocator_open1_unsigned_long_close1_close0_instantiation_3(
) {
    assert_eq!(
        ::std::mem::size_of::<std_vector>(),
        24usize,
...
#[test]
fn __bindgen_test_layout_std_allocator_open0_unsigned_long_close0_instantiation_12() {
    assert_eq!(
        ::std::mem::size_of::<std_allocator>(),
        1usize,
        concat!(
...
#[test]
fn __bindgen_test_layout_std_pair_open0_NetworKit_node_NetworKit_node_close0_instantiation_2() {
    assert_eq!(
        ::std::mem::size_of::<std_pair<NetworKit_node, NetworKit_node>>(),
        16usize,
        concat!(
...
#[test]
fn __bindgen_test_layout_std_pair_open0_unsigned_long_unsigned_long_close0_instantiation_1() {
    assert_eq!(
        ::std::mem::size_of::<std_pair<::std::os::raw::c_ulong, ::std::os::raw::c_ulong>>(),
        16usize,
        concat!(
...
#[test]
fn __bindgen_test_layout_std_vector_open0_NetworKit_node_std_allocator_open1_unsigned_long_close1_close0_instantiation_4(
) {
    assert_eq!(
        ::std::mem::size_of::<std_vector>(),
        24usize,
...
#[test]
fn __bindgen_test_layout_std_allocator_open0_unsigned_long_close0_instantiation_13() {
    assert_eq!(
        ::std::mem::size_of::<std_allocator>(),
        1usize,
        concat!(
